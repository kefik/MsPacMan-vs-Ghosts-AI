 ...
 * @param <LINK>
 */
public interface IGraphView<NODE, LINK> {
	
	/**
	 * This method may return new links which are not present in 'mapLinks'.
	 ...
	 * 
	 * @param node
	 * @param nodeMapCost cost of the node as returned by underlying {@link IPFMap#getNodeCost(Object)}
	 * 
	 * @return be careful abs(RETURN) must be &gt;= 'nodeMapCost' !
	 */
	public int getNodeExtraCost(NODE node, int nodeMapCost);
	 ...
	 * @return
	 */
	public int getLinkExtraCost(NODE node, LINK link, int linkMapCost);
	 ...
	 * @author Jimmy
	 */
	public class DefaultView<NODE, LINK> implements IGraphView<NODE, LINK> {
